...
export default function CreateListing({ auth }) {
    ...
    const addBedToRoom = (roomIndex) => {
        ...
        nextRooms[roomIndex] = {
            ...nextRooms[roomIndex],
            beds: [
                ...nextRooms[roomIndex].beds,
                { count: 1, type: "queen bed" },
            ],
        };
        setData("rooms", nextRooms);
    };
    ...
    const canContinueStep1 =
        data.title.trim().length > 0 && data.type.length > 0;
                            ...
                            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-zinc-500 max-w-2xl">
                                        Select category, set location, and
                                        define complete property details.
                                    </p>
                                </div>

                                <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-zinc-500">
                                    <span
                                        className={`px-3 py-1 rounded-full ${step >= 1 ? "bg-zinc-950 text-white" : "bg-zinc-100"}`}
                                    >
                                        1
                                    </span>
                                    <span
                                        className={`px-3 py-1 rounded-full ${step >= 2 ? "bg-zinc-950 text-white" : "bg-zinc-100"}`}
                                    >
                                        2
                                    </span>
                                    <span
                                        className={`px-3 py-1 rounded-full ${step >= 3 ? "bg-zinc-950 text-white" : "bg-zinc-100"}`}
                                    >
                                        3
                                    </span>
                                </div>
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className="flex items-center justify-between">
                                                                <Icon
                                                                    className={`w-5 h-5 ${active ? "text-white" : "text-zinc-500"}`}
                                                                />
                                                                <span
                                                                    className={`text-xs font-semibold uppercase tracking-wider ${active ? "text-zinc-200" : "text-zinc-400"}`}
                                                                >
                                                                    Step 1
                                                                </span>
                                                            </div>
                                                            ...
                                                            <p
                                                                className={`mt-2 text-sm ${active ? "text-zinc-200" : "text-zinc-500"}`}
                                                            >
                                                                {
                                                                    item.description
                                                                }
                                    ...
                                    <section className="space-y-8">
                                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <span className="absolute inset-y-0 left-4 flex items-center text-sm font-semibold text-zinc-400">
                                                        MAD
                                                    </span>
                                                    <input
                                                        type="number"
                                        ...
                                        <div className="rounded-2xl border border-zinc-200 bg-white p-5 space-y-5">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="min-w-8 text-center text-lg font-semibold text-zinc-900">
                                                    {data.max_guests}
                                                </span>
                                                <button
                                                    type="button"
                                            ...
                                            <label className="flex items-center gap-2 text-sm text-zinc-700">
                                                ...
                                                />
                                                Exclude infants (0-2 years old)
                                                from total number of guests
                                            </label>
                                        </div>
                                                        ...
                                                        {LANGUAGE_OPTIONS.map(
                                                            (language) => (
                                                                <label
                                                                    ...
                                                                    className="inline-flex w-full items-center gap-2 text-sm text-zinc-700"
                                                                >
                                                                    <input
                                                                        type="checkbox"
