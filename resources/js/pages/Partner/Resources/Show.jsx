                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <Card>
                                    ...
                                    <CardContent>
                                        ...
                                        <p className="text-xs text-emerald-500 flex items-center gap-1 mt-1">
                                            ...
                                            {analytics.this_week_views} this
                                            week
                                        </p>
                                    </CardContent>
                                </Card>
                                ...
                                <Card>
                                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                                        ...
                                        <div
                                            className={`w-3 h-3 rounded-full ${resource.is_active ? "bg-emerald-500" : "bg-red-500"}`}
                                        />
                                    </CardHeader>
                                    <CardContent>
                        ...
                        <TabsContent value="bookings">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Manage participants and approve pending
                                        reservations.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <Button
                                                    variant="ghost"
                                                    size="sm"
                                                    className="mt-2 text-xs text-zinc-500 gap-1 h-8 px-2 -ml-2"
                                                >
