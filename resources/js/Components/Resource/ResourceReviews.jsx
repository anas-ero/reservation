        ...
        <div className="space-y-6">
                    ...
                    <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
                        ...
                        <PopoverContent className="w-80 p-5 rounded-2xl shadow-xl border-border">
                            <form onSubmit={submitReview} className="space-y-4">
                                <div>
                                    <h4 className="font-bold text-zinc-900 mb-1">Your Rating</h4>
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-zinc-700 mb-1">Comment</label>
                                    <textarea
            ...
            {totalReviews === 0 ? (
                <div className="bg-card rounded-2xl border border-border p-8 text-center shadow-sm">
                    ...
                    <h4 className="text-zinc-900 font-bold mb-1">No reviews yet</h4>
                    <p className="text-sm text-zinc-500">Be the first to review this listing!</p>
                </div>
            ) : (
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-sm text-zinc-600 leading-relaxed">
                                    {review.comment || <span className="italic text-zinc-400">No comment provided.</span>}
                                </p>
                            </div>
                        )
                    })}
