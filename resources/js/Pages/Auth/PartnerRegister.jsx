    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-6 text-center">
                <h1 className="text-2xl font-bold text-zinc-900">Partner with ReserveFlow</h1>
                <p className="text-sm text-zinc-600 mt-2">Start renting your properties and vehicles.</p>
            </div>
            ...
            <form onSubmit={submit}>
                ...
                {/* NEW: Business Name */}
                <div className="mt-4">
                    <InputLabel htmlFor="business_name" value="Business or Agency Name" />
                    <TextInput
                        id="business_name"
                        name="business_name"
                ...
                {/* NEW: CIN or RC */}
                <div className="mt-4">
                    <InputLabel htmlFor="cin_or_rc" value="CIN / Registre de Commerce (RC)" />
                    <TextInput
                        id="cin_or_rc"
                        name="cin_or_rc"
                ...
                <div className="flex items-center justify-end mt-6">
                    ...
                    <PrimaryButton className="ms-4 bg-zinc-950" disabled={processing}>
